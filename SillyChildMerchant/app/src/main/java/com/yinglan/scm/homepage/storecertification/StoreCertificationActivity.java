package com.yinglan.scm.homepage.storecertification;
 ...
 * 店铺认证
 */
public class StoreCertificationActivity extends BaseActivity implements StoreCertificationContract.View, EasyPermissions.PermissionCallbacks {
    ...
    public void initData() {
        super.initData();
        mPresenter = new StoreCertificationPresenter(this);
    }
    ...
    public void widgetClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.img_storeLogo:
                ((StoreCertificationContract.Presenter) mPresenter).getIsLogin(aty, 1);
                break;
            case R.id.tv_asManager:
                ...
                ((StoreCertificationContract.Presenter) mPresenter).getIsLogin(aty, 2);
                break;
            default:
                break;
        }
    ...
    @Override
    public void setPresenter(StoreCertificationContract.Presenter presenter) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_SELECT:
                if (resultCode == ImagePicker.RESULT_CODE_ITEMS && data != null) {
                    ...
                    ((StoreCertificationContract.Presenter) mPresenter).upPictures(imgPath);
                } else {
                    ViewInject.toast(getString(R.string.noData));
                }
                break;
