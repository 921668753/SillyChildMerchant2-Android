package com.yinglan.scm.homepage.guidecertification;
 ...
 */
public class GuideCertificationPresenter implements GuideCertificationContract.Presenter {

    private GuideCertificationContract.View mView;

    public GuideCertificationPresenter(GuideCertificationContract.View view) {
        mView = view;
