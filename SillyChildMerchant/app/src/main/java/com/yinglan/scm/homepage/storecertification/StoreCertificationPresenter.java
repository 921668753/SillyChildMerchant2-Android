 ...
 */
public class StoreCertificationPresenter implements StoreCertificationContract.Presenter {

    private StoreCertificationContract.View mView;

    public StoreCertificationPresenter(StoreCertificationContract.View view) {
        mView = view;
